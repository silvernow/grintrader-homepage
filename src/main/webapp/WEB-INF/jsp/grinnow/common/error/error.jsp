    	...
    	<div class="wrapper vh-100">
      		<div class="align-items-center h-100 d-flex w-50 mx-auto">
        		<div class="mx-auto text-center">
          			...
          			<h1 class="mb-1 text-muted font-weight-bold">An unknown error has occurred.</h1>
          			<h6 class="mb-3 text-muted">An unknown error has occurred. Please contact your administrator.</h6>
